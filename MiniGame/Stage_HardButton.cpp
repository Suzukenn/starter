...
//======定数・マクロ定義=====
// パス名
#define FILE_PATH	L"Data/Game/Select_HardButton.png"
//スタートボタンサイズ
...
//=====コンストラクタ=====
STAGEHARDBUTTON::STAGEHARDBUTTON()
{
    //動的確保
...
//戻り値：(HRESULT)処理の成否
/////////////////////////////////////////////
HRESULT STAGEHARDBUTTON::Initialize(void)
{
    //---各種宣言---//
    int nCounter;
    HRESULT hResult;
...
//戻り値：なし
/////////////////////////////////////////////
void STAGEHARDBUTTON::Uninitialize(void)
{
    //---解放---//
    if (VertexBuffer)
    {
...
//戻り値：なし
/////////////////////////////////////////////
void STAGEHARDBUTTON::Draw(void)
{
    //---各種宣言---//
    LPDIRECT3DDEVICE9 pDevice;
...
//戻り値：なし
/////////////////////////////////////////////
void STAGEHARDBUTTON::Update(void)
{
    //----- 各種宣言 -----
    ...
    {
        //ゲームシーン切替
        SCENE_MANAGER::SetScene(SCENE_GAME_3);
