...
//戻り値：(bool)判定結果
/////////////////////////////////////////////
bool MOVECAMERA::CheckPlayer(D3DXVECTOR2 player_pos, D3DXVECTOR2 size)
{
...
//戻り値：(HRESULT)処理の成否
/////////////////////////////////////////////
HRESULT MOVECAMERA::Initialize(D3DXVECTOR2 position)
{
    //---各種宣言---//
    int nCounter;
    HRESULT hResult;
...
//戻り値：なし
/////////////////////////////////////////////
void MOVECAMERA::Uninitialize(void)
{
...
void MOVECAMERA::Update(void)
{
    ...
    //---データ更新---//
    SinWave += 1.5F;
    Angle += sinf(D3DXToRadian(SinWave)) / 2.0F;
