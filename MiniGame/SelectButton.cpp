...
//======定数・マクロ定義=====
// パス名
#define FILE_PATH	L"Data/Game/SelectButton.png"
//スタートボタンサイズ
...
//戻り値：(HRESULT)処理の成否
/////////////////////////////////////////////
HRESULT SELECTBUTTON::Initialize(void)
{
    //---各種宣言---//
    int nCounter;
    HRESULT hResult;
...
//戻り値：なし
/////////////////////////////////////////////
void SELECTBUTTON::Uninitialize(void)
{
    //---解放---//
    if (VertexBuffer)
    {
