...
//======定数・マクロ定義=====
// パス名
#define FILE_PATH	L"Data/Game/Select_NormalButton.png"
//スタートボタンサイズ
...
//=====コンストラクタ=====
STAGENORMALBUTTON::STAGENORMALBUTTON()
{
    //動的確保
...
//戻り値：(HRESULT)処理の成否
/////////////////////////////////////////////
HRESULT STAGENORMALBUTTON::Initialize(void)
{
    //---各種宣言---//
    int nCounter;
    HRESULT hResult;
...
//戻り値：なし
/////////////////////////////////////////////
void STAGENORMALBUTTON::Uninitialize(void)
{
    //---解放---//
    if (VertexBuffer)
    {
...
//戻り値：なし
/////////////////////////////////////////////
void STAGENORMALBUTTON::Draw(void)
{
    //---各種宣言---//
    LPDIRECT3DDEVICE9 pDevice;
...
//戻り値：なし
/////////////////////////////////////////////
void STAGENORMALBUTTON::Update(void)
{
    //----- 各種宣言 -----
